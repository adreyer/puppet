  ...
  context 'task information service' do
    ...
    context 'task_data method' do
      ...
      context 'For a module with multiple implemenations and files' do
        ...
        let(:metadata) {
          { "implementations" => [
            {"name" => "thingtask.rb", "requirements" => ["puppet_agent"],
             "files" => ["#{mod_name}/lib/puppet/providers/prov.rb"]},
        ...
        { 'name' => "shell_helpers/files/scripts/helper.sh",
          'path' => "#{modpath}/#{mod_name}/shell_helpers/files/scripts/helper.sh" }
        ].sort_by {|f| f['name']} }
                                              ...
                                              {:environment => env,
                                               :tasks => [['thingtask.rb',
                                                           ...
                                                           {:name => 'thingtask.json',
                                                            ...
                                                            :files => {
                                                              "files/my_data.json" => "{}",
                                                              "lib/providers/prov.rb" => "provider_content"} })
